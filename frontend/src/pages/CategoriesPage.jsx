...
import { FolderPlus, List, RefreshCw } from 'lucide-react';
    ...
    <div className="flex-1 bg-slate-950 text-slate-100 p-8 overflow-y-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Initialize Category settings for CSR Activities and Gamification Challenges.</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl self-start">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-2 bg-emerald-600 hover:bg-emerald-500 transition text-slate-950 rounded-lg text-sm font-bold shadow-lg shadow-emerald-500/10"
            >
              Initialize Category
            </button>
          </form>
        ...
        <div className="lg:col-span-2 bg-slate-900 border border-slate-800 p-6 rounded-xl">
          <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
            <List className="w-5 h-5 text-emerald-450" />
