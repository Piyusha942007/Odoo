    ...
    <div className="space-y-8 min-h-screen text-slate-100 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 border-b border-white/5 pb-6">
        ...
        <button 
          ...
          className="flex items-center justify-center gap-2 px-5 py-3.5 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 hover:opacity-95 active:scale-95 text-white rounded-2xl font-extrabold transition-all duration-200 shadow-lg shadow-indigo-500/15"
        >
          <Plus size={18} />
          Create Document
        </button>
                ...
                <div className="border-t border-white/5 pt-5 space-y-3">
                  ...
                  <form onSubmit={handleAcknowledge} className="flex gap-2">
                    ...
                    <button 
                      ...
                      className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:opacity-95 disabled:from-blue-800 disabled:to-indigo-800 text-white text-xs font-black px-4 py-2.5 rounded-xl transition-all shrink-0"
                    >
          ...
          <div className="w-full max-w-xl bg-slate-950 border border-white/5 rounded-3xl p-6 shadow-2xl space-y-6 relative">
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div className="flex gap-3 justify-end pt-4">
                ...
                <button 
                  type="submit"
                  className="px-5 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-xl text-xs font-black transition-all shadow-md shadow-blue-500/10"
                >
                  Save Policy
                </button>
              </div>
          ...
          <div className="w-full max-w-xl bg-slate-950 border border-white/5 rounded-3xl p-6 shadow-2xl space-y-6 relative">
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              ...
              <div className="flex gap-3 justify-end pt-4">
                ...
                <button 
                  type="submit"
                  className="px-5 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-xl text-xs font-black transition-all shadow-md"
                >
                  Save Changes
                </button>
              </div>
