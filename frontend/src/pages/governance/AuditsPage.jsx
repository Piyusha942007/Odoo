      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 border-b border-white/5 pb-6">
        ...
        <div className="flex gap-3 self-start md:self-center">
          ...
          <button 
            ...
            className="flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 hover:opacity-95 active:scale-95 text-white rounded-2xl font-extrabold transition-all text-xs shadow-lg shadow-indigo-500/10"
          >
            <Plus size={14} />
            Log Issue
          </button>
          ...
          <div className="w-full max-w-lg bg-slate-950 border border-white/5 rounded-3xl p-6 shadow-2xl space-y-6 relative">
            ...
            <form onSubmit={handleCreateAudit} className="space-y-4">
              ...
              <div className="flex gap-3 justify-end pt-4">
                ...
                <button 
                  type="submit"
                  className="px-5 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-xl text-xs font-black transition-all"
                >
                  Schedule
                </button>
              </div>
